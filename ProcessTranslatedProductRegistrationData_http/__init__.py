...
SPECIAL_KEYS = [
    "IngredientList", "ShortIngredientList", "LegalName",
    "#ProductLegalName#", "#IngredientList#", "#ShortIngredientList#"
]
...
# def parse_styles_text(text: str):
#     """Parse multiline JSON text from cococola_targetstyles into a list."""
#     if not text:
#         return []
#     try:
...
def build_response(token, case_id):
    """Build ProductRegistrationResponse for a given case_id."""
    try:
        response = {
            "requestId": None,
            "assessmentId": None,
        ...
        select_fields = [
            ...
            "cococola_value", "cococola_language", "cococola_translatedtext",
            "cococola_translationsource", "cococola_targetstyles"
        ]
        rows = fetch_records(
            token,
        ...
        if rows:
            # The first row carries source language for the dataset
        ...
        for rec in rows:
            ...
            if key in SPECIAL_KEYS:
                ...
                base["translations"] = {"translation": full_trans, "values": vals, "styles": styles}
...
def main(req: HttpRequest) -> HttpResponse:
    logging.info("ProductRegistration HTTP trigger fired.")
    try:
        try:
            body = req.get_json()
        except ValueError:
...
# # Special keys requiring word-level handling
# SPECIAL_KEYS = ["IngredientList", "ShortIngredientList", "LegalName","#ProductLegalName#","#IngredientList#","#ShortIngredientList#"]
