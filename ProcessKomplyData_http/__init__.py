...
DATAVERSE_TRANSLATION_LANGUAGECOUNTRY_SELECTION_TABLE = "cococola_tccc_languagecountryselection"
...
def main(req: HttpRequest) -> HttpResponse:
    ...
    try:
        ...
        return func.HttpResponse(f"Data processed successfully for {case_id}", status_code=200)
...
def parse_language_countries_values(data: dict, case_id: str, token: str):
    ...
    for lang in languages:
        ...
        store_to_dataverse(DATAVERSE_TRANSLATION_LANGUAGECOUNTRY_SELECTION_TABLE, p1, token)
